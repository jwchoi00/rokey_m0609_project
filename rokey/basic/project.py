    ...
    def check_cup_position_and_release(goal_point):
        ...
        while True:
            ...
            if fcon1 == 0: #외력이 감지가 되었을 때
                ...
                print("컵 놓기 끝")
                mwait()
                current_xy_position,_ = get_current_posx()
                current_xy_position = [current_xy_position[0], current_xy_position[1], 400, current_xy_position[3],current_xy_position[4],current_xy_position[5]]
...
######################################################################################################
    ...
    try:
        ...
        point_home = posx(410.25,235.35,262,0,-180,0) #잡을 위치 설정
        ...
        third_floor_point = posx([center_point[0], center_point[1],400,0,-180,0])
        reverse_point = posx(277.43,-222.86, 250,0,-180,0)
        ...
        gripper_open()
        movej(posj(0,0,90,0,90,0),v=20,acc=20)
